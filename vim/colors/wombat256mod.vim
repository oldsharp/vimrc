...
hi Search       ctermfg=231       ctermbg=241       cterm=none        guifg=#d787ff       guibg=#636066       gui=none
...
if version >= 700
  ...
  " Uncomment the line below if you do not want to highlight the whole cursorline.
  "hi clear CursorLine
